...
import { School, FerrisWheel, Volleyball, PaletteIcon } from "lucide-react";
...
export default function HeroSection({ user }: any) {
  ...
  const itemVariants = {
    ...
    visible: (index: number) => ({
      ...
      transition: {
        duration: 0.8,
        delay: 0.5 + index * 0.2, // Staggered delay
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            ...
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <Button size={"lg"}>View Homework</Button>
                ...
                {subjects.map((subject, index) => (
                  ...
                  >
                    <Card
                      key={index}
                      className={cn(
                        "w-full flex flex-col items-center justify-center shadow-lg",
                        subject.color,
                        "rounded-2xl"
                      )}
                      onClick={() => navigate(`${subject.naviagteTo}`)}
                    >
                      <CardContent className="flex flex-col items-center justify-center p-4">
                        <subject.icon className="w-12 h-12 text-white mb-2" />
